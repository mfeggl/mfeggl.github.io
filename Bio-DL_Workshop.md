...
{% assign upcoming = workshops | where_exp: "post", "post.upcoming == true" | sort: "date" | reverse | first %}
{% assign past_workshops = workshops | where_exp: "post", "post.upcoming == false" | sort: "date" | reverse %}

The next **Bio-inspired Deep Learning Workshop** will take place in **2026**.
Details about the upcoming edition can be found here:
